...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "wix alternatief",
    "shopify alternatief goedkoper",
    "website migreren haarlem",
    "trage wordpress site sneller",
    "wordpress naar next.js",
    "wix naar eigen website",
    "stop met shopify betalen",
  ],
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  const jsonLd = buildSiteGraphSchema([
    ...
    {
      "@type": "Offer",
      "@id": `${SITE_URL}/#offer-wordpress-migratie`,
      name: "WordPress naar Next.js migratie",
      description: "Migratie van WordPress naar Next.js met behoud van SEO, content en domeinnaam.",
      price: "399",
      priceCurrency: "EUR",
