...
export const BRANCHES: Record<string, BrancheEntry> = {
  horeca: {
    ...
    config: {
      ...
      accent: "#ea580c",
      heroFoto: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1600&q=80",
      ...
      features: [
        ...
        },
        {
          ...
          foto: "https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?w=800&q=80",
        },
        {
          icon: "🗺️",
      ...
      faq: [
        ...
        },
        {
          ...
          foto: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=800&q=80",
        },
      ],
  ...
  beauty: {
    ...
    config: {
      ...
      heroFoto: "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=1600&q=80",
      ...
      features: [
        ...
        },
        {
          ...
          foto: "https://images.unsplash.com/photo-1604654894610-df63bc536371?w=800&q=80",
        },
        {
          icon: "📸",
          title: "Voor & na foto's",
          desc: "Laat resultaten zien die nieuwe klanten overtuigen.",
          foto: "https://images.unsplash.com/photo-1487412947147-5cebf100d293?w=800&q=80",
        },
        {
          icon: "⭐",
        ...
        },
        {
          ...
          foto: "https://images.unsplash.com/photo-1549465220-1a8b9238cd48?w=800&q=80",
        },
        {
          icon: "🔒",
          title: "AVG-compliant",
  ...
  bouw: {
    ...
    config: {
      ...
      accent: ACCENT.amber,
      heroFoto: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1600&q=80",
      ...
      features: [
        {
          ...
          foto: "https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=800&q=80",
        },
        {
          icon: "🗺️",
  ...
  zorg: {
    ...
    config: {
      ...
      accent: ACCENT.cyan,
      heroFoto: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=1600&q=80",
      ...
      features: [
        ...
        },
        {
          ...
          foto: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=800&q=80",
        },
        {
          icon: "📋",
  ...
  zzp: {
    ...
    config: {
      ...
      accent: ACCENT.blue,
      heroFoto: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=1600&q=80",
  ...
  "non-profit": {
    ...
    config: {
      ...
      accent: ACCENT.green,
      heroFoto: "https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=1600&q=80",
      ...
      features: [
        ...
        },
        {
          ...
          foto: "https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=800&q=80",
        },
        {
          icon: "📰",
        ...
        },
        {
          ...
          foto: "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=800&q=80",
        },
        {
          icon: "🤝",
          title: "Partners & sponsors",
          desc: "Toon uw samenwerkingspartners prominent.",
          foto: "https://images.unsplash.com/photo-1600880292089-90a7e086ee0c?w=800&q=80",
        },
        {
          icon: "🔒",
          title: "AVG-compliant",
  ...
  webshop: {
    ...
    config: {
      ...
      heroFoto: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1600&q=80",
  ...
  tandarts: {
    ...
    config: {
      ...
      accent: ACCENT.cyan,
      heroFoto: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=1600&q=80",
  ...
  vastgoed: {
    ...
    config: {
      ...
      accent: ACCENT.stone,
      heroFoto: "https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1600&q=80",
